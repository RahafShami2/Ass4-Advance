...
public class Demo {
	...
	public static void main(String[] args) {
        ...
        Protocol ssh = Factory.getInstance(ConnectionType.SSH);
		Protocol ssh2 = Factory.getInstance(ConnectionType.SSH);
		Protocol telnet = Factory.getInstance(ConnectionType.TELNET);
		Protocol scp = Factory.getInstance(ConnectionType.SCP);
		Protocol ftp = Factory.getInstance(ConnectionType.FTP);
